            ...
            <!-- ADD TUTORIAL -->
             <section class="bg-light p-6 mt-7 rounded-[10px] w-full shadow-[0px_4px_4px_-0px_rgba(0,0,0,0.25)]">
                <div class="flex flex-row">
                    <a href="../informasi-tutorial/" class="self-center">
                    ...
                    <div class="flex flex-col gap-[5px] text-center mx-auto">
                        <h1 class="text-dark font-bold text-[24px] text-center">Tambah Video Tutorial Baru</h1>
                        <p class="text-dark text-sm font-light">Bagikan Informasi dan Tutorial Daur Ulang Kepada Komunitas</p>
                    </div>
                </div>
                <form action="" class="flex flex-col gap-9 mt-[26px] text-dark">
                    <div class="flex flex-col gap-[10px] w-1/2">
                        <label for="judul-video" class="px-1 text-2xl font-medium">Judul Video</label>
                        <input type="text" id="judul-video" name="judul-video" placeholder="Masukkan judul video" class="w-full h-12 bg-light border border-gray px-3 font-light shadow-[0px_4px_4px_rgba(0,0,0,0.25)]">
                    </div>
                    <div class="flex flex-col gap-[10px] w-full">
                        <label for="judul-video" class="px-1 text-2xl font-medium">Deskripsi Video</label>
                        <textarea type="text" id="judul-video" name="judul-video" placeholder="Isi deskripsi Video" class="w-full min-h-[211px] bg-light border border-gray px-3 py-3 font-light shadow-[0px_4px_4px_rgba(0,0,0,0.25)]"></textarea>
                    </div>
                    <div class="flex flex-col gap-[10px] w-full">
                        <label for="judul-video" class="px-1 text-2xl font-medium">Thumbnail Video</label>
                    ...
                    <div class="grid grid-cols-2 gap-11">
                        <div class="flex flex-col gap-[10px] w-full">
                            <label for="judul-video" class="px-1 text-2xl font-medium">Link Video</label>
                            <input type="text" id="judul-video" name="judul-video" placeholder="Masukkan Link Video" class="w-full h-12 bg-light border border-gray px-3 font-light shadow-[0px_4px_4px_rgba(0,0,0,0.25)]">
                        </div>
                        <div class="flex flex-col gap-[10px] w-full">
                            <label for="judul-video" class="px-1 text-2xl font-medium">Tags</label>
