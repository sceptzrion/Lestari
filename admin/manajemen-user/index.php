                    ...
                    <div class="overflow-x-auto">
                        <table class="table border-collapse border border-[#828282] text-center text-dark">
                            ...
                            <tr>
                                ...
                                <td class="border border-[#828282]">
                                    <button class="bg-[#C0392B] rounded-[10px] border border-gray w-auto h-auto text-xs p-1.5 text-light font-medium text-center" onclick="getElementById('unactive').showModal()">
                                        Nonaktifkan
                                    </button>
                                </td>
                            </tr>
