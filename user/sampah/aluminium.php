...
<head>
  ...
  <title>Sampah Aluminium - Lestari</title>
  <!-- Google Fonts -->
...
<script>
  ...
  <h1 class="text-2xl text-[#1B5E20] text-center font-bold mb-3">Sampah Aluminium</h1>
    <div class="bg-white rounded-lg shadow-md p-6">
      <p class="text-gray-700 mb-6 text-justify">
      Aluminium dapat didaur ulang 100% dan berulang kali tanpa mengurangi kualitasnya. Proses daur ulang aluminium menghemat 95% energi dibandingkan dengan pembuatan aluminium baru dari bijih bauksit.      </p>
      <div class="bg-green-100 p-6 rounded-lg shadow-inner">
        <h2 class="text-lg font-bold text-[#1B5E20] mb-2">Cara Pengolahan Aluminium:</h2>
        <ol class="list-decimal pl-5 text-gray-700 space-y-2">
        <li>Bersihkan kaleng Aluminium dari sisa isi</li>
        <li>Pisahkan bagian aluminium dengan material lain</li>
        <li>Tekan kaleng agar lebih pipih</li>
        <li>Kumpulkan dalam wadah khusus logam</li>
