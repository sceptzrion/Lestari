...
<head>
  ...
  <title>Sampah Elektronik - Lestari</title>
  <!-- Google Fonts -->
...
<script>
  ...
  <h1 class="text-2xl text-[#1B5E20] text-center font-bold mb-3">Sampah Elektronik</h1>
    <div class="bg-white rounded-lg shadow-md p-6">
      <p class="text-gray-700 mb-6 text-justify">
      Sampah elektronik mengandung bahan berbahaya sekaligus berharga. Penanganan yang tepat dapat mengambil material berharga dan mencegah pencemaran lingkungan.      </p>
      <div class="bg-green-100 p-6 rounded-lg shadow-inner">
        <h2 class="text-lg font-bold text-[#1B5E20] mb-2">Cara Pengolahan Elektronik:</h2>
        <ol class="list-decimal pl-5 text-gray-700 space-y-2">
        <li>Hapus apabila terdapat data pribadi dari perangkat elektronik</li>
        <li>Pisahkan baterai dari perangkat</li>
        <li>Kemas dengan aman untuk mencegah kerusakan</li>
        <li>Jangan membakar atau membongkar sendiri</li>
