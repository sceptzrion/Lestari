...
<head>
  ...
  <title>Sampah Plastik - Lestari</title>
  <!-- Google Fonts -->
...
<script>
  ...
  <h1 class="text-2xl text-[#1B5E20] text-center font-bold mb-3">Sampah Plastik</h1>
    <div class="bg-white rounded-lg shadow-md p-6">
      <p class="text-gray-700 mb-6 text-justify">
      Plastik membutuhkan waktu ratusan tahun untuk terurai. Daur ulang plastik sangat penting untuk mengurangi pencemaran lingkungan. Satu botol plastik dapat membutuhkan hingga 450 tahun untuk terurai secara alami.
      </p>
      <div class="bg-green-100 p-6 rounded-lg shadow-inner">
        <h2 class="text-lg font-bold text-[#1B5E20] mb-2">Cara Pengolahan Plastik:</h2>
        <ol class="list-decimal pl-5 text-gray-700 space-y-2">
        <li>Bersihkan plastik dari sisa makanan atau kotoran</li>
        <li>Pisahkan berdasarkan jenis (PET, HDPE, dll)</li>
        <li>Kempiskan barang berupa botol plastik untuk menghemat ruang</li>
