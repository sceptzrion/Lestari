...
<head>
  ...
  <title>Sampah Khusus - Lestari</title>
  <!-- Google Fonts -->
...
<script>
  ...
  <h1 class="text-2xl text-[#1B5E20] text-center font-bold mb-3">Sampah Khusus</h1>
    <div class="bg-white rounded-lg shadow-md p-6">
      <p class="text-gray-700 mb-6 text-justify">
      Sampah khusus mencakup material berbahaya atau beracun yang memerlukan penanganan spesial untuk mencegah dampak negatif pada lingkungan dan kesehatan.      </p>
      <div class="bg-green-100 p-6 rounded-lg shadow-inner">
        <h2 class="text-lg font-bold text-[#1B5E20] mb-2">Cara Pengolahan Khusus:</h2>
        <ol class="list-decimal pl-5 text-gray-700 space-y-2">
        <li>Identifikasi jenis sampah khusus</li>
        <li>Simpan dalam wadah tertutup rapat</li>
        <li>Hindari mencampur dengan sampah lain</li>
        <li>Gunakan pelindung diri saat menangani</li>
