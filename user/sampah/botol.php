...
<head>
  ...
  <title>Sampah Botol Kaca - Lestari</title>
  <!-- Google Fonts -->
...
<script>
  ...
  <h1 class="text-2xl text-[#1B5E20] text-center font-bold mb-3">Sampah Botol Kaca</h1>
    <div class="bg-white rounded-lg shadow-md p-6">
      <p class="text-gray-700 mb-6 text-justify">
      Botol kaca dapat didaur ulang 100% dan dapat digunakan berulang kali. Daur ulang kaca menghemat energi dan mengurangi penggunaan bahan baku alam.
      </p>
      <div class="bg-green-100 p-6 rounded-lg shadow-inner">
        <h2 class="text-lg font-bold text-[#1B5E20] mb-2">Cara Pengolahan Botol Kaca:</h2>
        <ol class="list-decimal pl-5 text-gray-700 space-y-2">
        <li>Bersihkan botol dari sisa isi dan label</li>
        <li>Pisahkan berdasarkan warna (bening, hijau, coklat)</li>
        <li>Hindari memecahkan botol</li>
        <li>Simpan dalam wadah yang kuat</li>
