...
<head>
  ...
  <title>Sampah Kertas - Lestari</title>
  <!-- Google Fonts -->
...
<script>
  ...
  <!-- Main Content -->
  <main class="bg-light container mx-auto md:px-16 px-8 md:py-10 py-5">
  <h1 class="text-2xl text-[#1B5E20] text-center font-bold mb-3">Sampah Kertas</h1>
    <div class="bg-white rounded-lg shadow-md p-6">
      <p class="text-gray-700 mb-6 text-justify">
        Kertas adalah material yang dapat didaur ulang hingga 4-6 kali. Daur ulang kertas dapat
        menghemat energi dan mengurangi penebangan pohon. Setiap ton kertas yang didaur ulang dapat
        menyelamatkan 17 pohon dan menghemat 7000 galon air.
      </p>
      <div class="bg-green-100 p-6 rounded-lg shadow-inner">
        <h2 class="text-lg font-bold text-[#1B5E20] mb-2">Cara Pengolahan Kertas:</h2>
        <ol class="list-decimal pl-5 text-gray-700 space-y-2">
          <li>Pisahkan kertas berdasarkan jenisnya (HVS, koran, kardus).</li>
          <li>Pastikan kertas dalam kondisi bersih dan kering.</li>
          <li>Ratakkan atau lipat rapi untuk memudahkan penyimpanan.</li>
          <li>Ikat dengan tali atau masukkan dalam kardus.</li>
          <li>Serahkan ke bank sampah LESTARI terdekat.</li>
        </ol>
      </div>
      <button onclick="window.location.href='../../landingpage.php'" class="mt-6 px-6 py-2 bg-gradient-to-r from-green to-dark-green text-white rounded-lg hover:bg-green-700">
        Kembali
    </button>    </div>
  </main>
