  ...
  <!-- NAVBAR END -->
    ...
    <main class="container mx-auto px-4 py-12">
        <div class="bg-white rounded-xl shadow-lg p-6 relative">
            ...
            <div class="text-center">
                <img src="https://placehold.co/100x100?text=Icon" alt="Icon" class="mx-auto mb-4">
                <h2 class="text-lg font-semibold text-green-700 flex items-center justify-center">
            ...
            <div class="mt-6 space-y-4">
                <div>
                    ...
                    <div class="bg-gray-10 rounded-lg shadow p-4 flex justify-between items-center">
    ...
    <div id="rewardModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 hidden">
     <div class="bg-white rounded-lg p-6 w-80 text-center relative">
      ...
      <div class="mb-4">
        <img src="https://placehold.co/100x100" alt="Reward Icon" class="mx-auto">
      </div>
      <h2 class="text-pink-500 font-bold text-lg mb-2">Selamat!</h2>
