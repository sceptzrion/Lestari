...
<div class="navbar-center hidden lg:flex">
  ...
  <main class="container mx-auto px-4 py-8">
    <h2 class="text-3xl font-bold text-green-600 mb-2">Kontak Kami</h2>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div class="bg-green-100 p-6 rounded-lg shadow-lg">
        <h3 class="text-lg font-bold text-green-600 mb-4">Alamat Kantor</h3>
        <p class="text-gray-700 mb-4">Jl. Lingkungan Hijau No. 123<br>Jakarta Selatan, 12345</p>

        <h3 class="text-lg font-bold text-green-600 mb-4">Email</h3>
        ...
        <h3 class="text-lg font-bold text-green-600 mb-4">Telepon</h3>
        <p class="text-gray-700 mb-4">(021) 1234-5678<br>0800-1234-5678 (Bebas Pulsa)</p>

        <h3 class="text-lg font-bold text-green-600 mb-4">Jam Operasional</h3>
        <p class="text-gray-700 mb-4">
        ...
        <div class="flex space-x-4 mt-4">
          <a href="#" class="text-green-600 hover:text-green-800">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.56v14.88C24 21.94 22.94 24 21.44 24H2.56C1.06 24 0 21.94 0 19.44V4.56C0 3.06 1.06 0 2.56 0h18.88C22.94 0 24 3.06 24 4.56z"/></svg>
          </a>
          <a href="#" class="text-green-600 hover:text-green-800">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.56v14.88C24 21.94 22.94 24 21.44 24H2.56C1.06 24 0 21.94 0 19.44V4.56C0 3.06 1.06 0 2.56 0h18.88C22.94 0 24 3.06 24 4.56z"/></svg>
          </a>
      ...
      <div class="bg-white p-6 rounded-lg shadow-lg">
        <form action="#" method="POST" class="space-y-6">
          ...
          <button type="submit" class="w-full py-3 bg-green-500 text-white font-semibold rounded-lg shadow hover:bg-green-600">Kirim Pesan</button>
        </form>
      </div>
    </div>
  </main>
